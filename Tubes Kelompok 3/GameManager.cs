...
{
    public enum AlurGame { NULL, HalamanLogin, HalamanRegistrasi, MAIN_MENU, MENU_PILIH_MODE, LEVEL_GAMBAR, LEVEL_MEMILIH_KATA, LEVEL_MENCOCOKKAN_KATA, MODE_MEMILIH_KATA,MODE_GAMBAR,MODE_MENCOCOKAN_KATA }
